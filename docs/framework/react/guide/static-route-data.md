...
When creating routes, you can optionally specify a `staticData` property in the route's options. This object can literally contain anything you want it to be as long as it's synchronous available when you create your route.
